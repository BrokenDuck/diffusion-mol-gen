...
class ScoreSDE:
    ...
    def q_sample(self, x_0: Tensor, t: Tensor, noise: Tensor | None = None) -> tuple[Tensor, Tensor, Tensor]:
        """
        Args:
            x_0: [N, 3]
            t:   [N] float in [0, 1]
    ...
    def reverse_em_step(
        ...
        """
        t_tensor = t if isinstance(t, Tensor) else torch.full((x_t.shape[0],), t, device=x_t.device)
